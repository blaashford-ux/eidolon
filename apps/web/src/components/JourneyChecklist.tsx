...
const items: ChecklistItem[] = [
  ...
  { id: 'con-2', label: 'Contributor: open submission details and placeholder actions', to: '/submissions/sub-101', personas: ['contributor', 'reader'] },
  { id: 'rea-1', label: 'Reader: run search query and inspect source metadata', to: '/search', personas: ['reader'] },
  { id: 'rea-2', label: 'Reader: open graph placeholder with recovery navigation', to: '/graph', personas: ['reader'] },
...
const STORAGE_KEY = 'eidolon.phase1.checklist';
  ...
  return (
    <article className="panel">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-lg font-semibold text-white">Phase 1 journey checklist</h3>
